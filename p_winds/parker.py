...
def mean_molecular_weight(ion_fraction_profile, r_profile, v_profile,
    ...
    r_profile (``numpy.ndarray``):
        Radius profile in unit of Jupiter radii. This is the independent
        parameter on which the profiles are described.
    ...
    mu_r = (1 + 4 * he_h_fraction) / \
        (1 + he_h_fraction + ion_fraction_profile) * m_h
